...
def render_predictions(cfg, points, predicted_points, cam_poses, normals_traced, predicted_normals, whole_intersected_mask, true_mask,
    ...
    true_map = render_image(true_distance[..., None], true_mask, cfg.visualization.image_size, path, cfg.device)
    ...
    predicted_map = render_image(predicted_distance[..., None], whole_intersected_mask, cfg.visualization.image_size, path, cfg.device)
